"""Add opencode_file_path to OpenCodeSkill

Revision ID: 8f2355fe393f
Revises: 008_add_files_with_findings
Create Date: 2026-03-15 16:49:50.233136
...
def upgrade() -> None:
    ...
    op.alter_column('instant_analyses', 'analysis_time',
               ...
               nullable=True,
               existing_server_default=sa.text("'0'::double precision"))
    op.add_column('opencode_skills', sa.Column('opencode_file_path', sa.String(length=500), nullable=True))
...
def downgrade() -> None:
    ...
    op.alter_column('project_members', 'role',
               ...
               nullable=False,
               existing_server_default=sa.text("'member'::character varying"))
    op.drop_column('opencode_skills', 'opencode_file_path')
    op.alter_column('instant_analyses', 'analysis_time',
               existing_type=sa.DOUBLE_PRECISION(precision=53),
               nullable=False,
               existing_server_default=sa.text("'0'::double precision"))
